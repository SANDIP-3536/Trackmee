                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3><b>Stoppage Reports Detail</b></h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tabs-container">
                                <div class="tabs-left">
                                    <ul class="nav nav-tabs" style="width:15% !important;">
                                        ...
                                        <li class="active"><a data-toggle="tab" href="#stoppage_report">Stoppage Report</a></li>
                                    ...
                                    <div class="tab-content ">
                                        <div id="distance_report" class="tab-pane">
                                        ...
                                        <div id="stoppage_report" class="tab-pane active">
                                            <div class="panel-body" style="margin-left:15% !important;width:85%;">
                                                <div class="wrapper wrapper-content animated fadeInRight">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                                    ...
                                                                    <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-sm-5 col-sm-offset-1">   
                                                                             ...
                                                                             <div class="col-sm-5 col-sm-offset-1">   
                                                                                <a href="<?=site_url('Stoppage/view_stoppage_map')?>"><span class="btn btn-info hidden" id="stoppage_on_map">Stoppage Map</span></a>
                                                                                <!-- <input type='button' class="btn btn-warning" value='Print Report' onclick='printDiv("example");'/> -->
                                                                            </div>
                                                                        </div>  
                                                                    </form>
