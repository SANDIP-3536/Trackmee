            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-collapse collapse" id="myNavbar">
                    <ul class="nav navbar-nav"> 
                        ...
                        <!-- <li id="employee">
                            <a href="<?=site_url('Employee/view_employee')?>"><img src="<?=base_url()?>assets/img/icon/driver.png" style="display: -webkit-box;font-size: initial;padding-left: 5px;"></i> Driver </a>
                        </li>
                        <li id="user">
                            <a href="<?=site_url('User/view_user')?>"><img src="<?=base_url()?>assets/img/icon/user.png" style="display: -webkit-box;font-size: initial;"></i> User </a>
                        </li>
                        <li id="route_de">
                            <a href="<?=site_url('Route/route_registration')?>"><img src="<?=base_url()?>assets/img/icon/route.png" style="display: -webkit-box;font-size: initial;padding-left: 4px;"></i> Route </a>
                        </li>
                        <li id="stop">
                            <a href="<?=site_url('Stop/stop_registration')?>"><img src="<?=base_url()?>assets/img/icon/stop.png" style="display: -webkit-box;font-size: initial;"></i> Stop </a>
                        </li> -->
                        <!-- <li class="dropdown" id="assign">
                            <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?=base_url()?>assets/img/icon/route.png" style="display: -webkit-box;font-size: initial;padding-left: 5px;"></i> Assign <span class="caret"></span></a>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="<?=site_url('Driver_bus_route_assgn/driver_bus_route_assign')?>"><i class="fa fa-bar-chart" style="display: inline;font-size: initial;"></i> <b> Driver Bus Route Assign</b></a></li>
                                <li><a href="<?=site_url('User_stop_assign/user_stop_assignment')?>"><i class="fa fa-bar-chart" style="display: inline;font-size: initial;"></i> <b> User Stop Assign</b></a></li>
                            </ul>
                        </li> -->
                        <!-- <li id="gallery">
