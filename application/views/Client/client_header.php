                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="navbar-collapse collapse" id="myNavbar">
                        <ul class="nav navbar-nav"> 
                            ...
                            <li id="notification">
                                <a href="<?=site_url('Notification/notification_details')?>"><img src="<?=base_url()?>assets/img/icon/noti.png" style="display: -webkit-box;font-size: initial;    padding-left: 20px;"></i> Notification </a>
                            </li> 
                           <!--  <li id="report">
