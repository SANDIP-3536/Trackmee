         <div class="wrapper wrapper-content">
              <?php foreach ($client_user as $key) { ?>
                        ...
                        <div class="col-lg-9">
                         ...
                         <div class="col-lg-3" style="text-align:right;">
                            <?php if ($key['employee_expiry_date'] == '9999-12-31') { ?>
                                <a href="<?=site_url('Client/disable_client_user/') .$key['employee_profile_id']?>"><button class="btn btn-xs btn-danger"><i class="fa fa-ban" title="Deactivate Employee"></i></button></a>
                                <a href="<?=site_url('Client/client_user_details/') .$key['employee_client_profile_id']?>"><span class="btn btn-xs btn-white"><i class="fa fa-times"></i></span></a>
                            <?php } ?>
                            <?php if ($key['employee_expiry_date'] != '9999-12-31') { ?>    
                                <a href="<?=site_url('Client/enable_client_user/') .$key['employee_profile_id']?>"><button class="btn btn-xs btn-success"><i class="fa fa-ban" title="Activate Employee"></i></button></a>
                                <a href="<?=site_url('Client/client_user_details/') .$key['employee_client_profile_id']?>"><span class="btn btn-xs btn-white"><i class="fa fa-times"></i></span></a>
                            <?php } ?>
                         </div>            
                    </div>
