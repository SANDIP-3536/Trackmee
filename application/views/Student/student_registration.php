                            ...
                            <form method="post" class="form-horizontal wizard-big wizard clearfix" enctype="multipart/form-data" id="form" action="add_student_registration">
                                ...
                                <fieldset style="padding:0px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3" style="padding:10px;">
                                            <div class="switch">
                                                <div class="onoffswitch">
                                                    <input type="checkbox" class="onoffswitch-checkbox" name="student_tracking" id="example1" style="display:none !important;">
                                                    <label class="onoffswitch-label" for="example1">
                                                        <span class="onoffswitch-inner"></span>
                                                        <span class="onoffswitch-switch" style="height:66% !important;"></span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <a href="<?=base_url()?>cam/demos/combo.html" target="_blank"><span class="btn btn-xs btn-success">Capture</span></a>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="ibox-content">
                                                <div class="form-group"  style="border-bottom: 1px solid #000000;">
                                                    ...
                                                    <label class="col-sm-2 control-label" style="text-align:center;">fee Name</label>
                                                    <label class="col-sm-2 control-label" style="text-align:center;">fee Category</label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="ibox-content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-2 control-label" style="text-align:center;"><?=$key['fee_category_name']?></label>
