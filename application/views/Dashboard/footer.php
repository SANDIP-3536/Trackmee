    ...
    <script>
        ...
        <?php } elseif($super_admin == 'institute') { ?>
            ...
            document.title = "TrackMee | Institute"
        <?php }elseif($super_admin == 'SMS') { ?>
            $('#SMS').addClass('active');
            document.title = "TrackMee | SMS Credits"
        <?php }else{ ?>
            $('#institute_header').addClass('active');
            document.title = "TrackMee | Password"
        <?php } ?> 
            ...
            $("#addInstitute").validate({
                ...
                messages: {
                    institute_name:{
                        ...
                        pattern:"Please enter character only.",
                    },
                    institute_logo:{
                    ...
                    institute_sender_id:{
                        pattern:"Please enter character only. For e.g SYNTEC",
                        minlength: "Please enter 6 Character.",
                        maxlength: "Please enter 6 Character."
                    },
                    institute_phone_number: {
