    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            <div class="navbar-header">
                 <img class="img-responsive" src="<?=base_url()?>assets/img/Trackmee_logo.png" style="height:82px;"></a>
            </div>
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav">
                    ...
                    <li id="institute">
                        <a href="<?=site_url('institute/institute_Details');?>"><img src="<?=base_url()?>assets/img/icon/university.png" style="display: -webkit-box;font-size: initial;padding-left: 10px;"></i> institute</a>
                    </li>
                    <li id="device">
                       <a href="<?=site_url('Device/device_registration')?>"><img src="<?=base_url()?>assets/img/icon/device.png" style="display: -webkit-box;font-size: initial;padding-left: 6px;"></i> Device </a>
                    </li>
                    <li id="bus">
                       <a href="<?=site_url('Bus/bus_registration')?>"><img src="<?=base_url()?>assets/img/icon/bus.png" style="display: -webkit-box;font-size: initial;"></i>&nbsp Bus</a>
                    </li>
                    <li id="SMS">
                        <a href="<?=site_url('Institute/sms_credit')?>"><img src="<?=base_url()?>assets/img/icon/mail.png" style="display: -webkit-box;font-size: initial;padding-left:15px;">SMS Credit</a>
                    </li>
                </ul>
