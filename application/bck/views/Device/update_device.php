                                ...
                                <div class="ibox-content">
                                    <form method="post" class="form-horizontal" enctype="multipart/form-data" id="addDevice" action="<?=site_url('Device/update_device_details')?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input type="text" placeholder="Device ID" name="device_id" class="form-control device" value="<?=$key['device_id']?>">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control mobile" name="device_mobile_number" placeholder="Device Mobile No." value="<?=$key['device_mobile_number']?>">
