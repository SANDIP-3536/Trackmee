    ...
    <script>
        ...
        $(document).ready(function(){
	        ...
	        $(document).on('click','.student_detaills_view',function(){
	        	$('.student_details_view').show();
	        	$('.father_details').hide();
		        $('.mother_details').hide();
		        $('.gardien_details').hide();
	        });
	        $(document).on('click','.father_detaills_view',function(){
	        	$('.student_details_view').hide();
	        	$('.father_details').show();
		        $('.mother_details').hide();
		        $('.gardien_details').hide();
	        });
		    ...
		    $('.auto_generate').hide();
		    $('.auto_generate_change').hide();
	        $('.GRN_number_change').click(function() {
		        $('.auto_generate').show();
		        $('.auto_generate_change').show();
		        $('.regular_generate').hide();
		        $('.GRN_number_change').hide();
	        })
	        $('.auto_generate_change').click(function() {
		        $('.regular_generate').show();
		        $('.GRN_number_change').show();
		        $('.auto_generate').hide();
		        $('.auto_generate_change').hide();
	        })
