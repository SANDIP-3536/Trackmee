                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" enctype="multipart/form-data" id="addStudent" action="<?=site_url('Student/add_student_registration')?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <div class="col-sm-4">
                                                <?php if ($enquiry != 1){?>
                                                    <input type="text" class="form-control student_first_name" name="student_first_name" placeholder="First Name" id="student_first_name" value="<?php echo $enquiry_details[0]['enquiry_student_first_name'] ?>" onkeyup="capitalize(this.id, this.value);">
                                                <?php }else{ ?>
                                                    <input type="text" class="form-control student_first_name" name="student_first_name" placeholder="First Name" id="student_first_name" onkeyup="capitalize(this.id, this.value);">
                                                <?php } ?>
                                            </div>
                                            <div class="col-sm-4">
                                                <?php if ($enquiry != 1){?>
                                                    <input type="text" class="form-control" name="student_middle_name" placeholder="Middle Name" value="<?php echo $enquiry_details[0]['enquiry_student_middle_name'] ?>" onkeyup="capitalize(this.id, this.value);">
                                                <?php }else{ ?>
                                            ...
                                            <div class="col-sm-4">
                                                <?php if ($enquiry != 1){?>
                                                    <input type="text" class="form-control" name="student_last_name" placeholder="Last Name" value="<?php echo $enquiry_details[0]['enquiry_student_last_name'] ?>" onkeyup="capitalize(this.id, this.value);">
                                                <?php }else{ ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="text" placeholder="GRN No." name="student_GRN_regular" class="form-control regular_generate">
                                        <label class="GRN_verification" hidden="" style="color:#cc5965; padding-top: -10px;"></label>
                                    </div>
                                    <div class="col-lg-3">
                                        <input type="text" placeholder="GRN No." name="student_GRN_auto" class="form-control auto_generate" value="<?php echo $GRN_number;?>">
                                        <label class="GRN_verification_auto" hidden="" style="color:#cc5965; padding-top: -10px;"></label>
                                    </div>
                                    <span class="btn btn-xs btn-primary GRN_number_change"><i class="fa fa-refresh" title="Genrate"></i></span>
                                    <span class="btn btn-xs btn-primary auto_generate_change"><i class="fa fa-times" title="Genrate"></i></span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <INPUT type="text" placeholder="Student Cast" name="student_cast" class="form-control">
                                    </div>
                                    <label class="col-lg-2 control-label">Sub Cast</label>
                                    <div class="col-lg-3">
                                        <INPUT type="text" placeholder="Student Sub Cast" name="student_sub_cast" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="ibox-title" style="border:none;border-top:1px solid black;">
                                    <div class="row">
                                        <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                    <?php if($enquiry != 1){ ?>
                                         <input type="text" class="form-control student_present_pre_house" name="student_present_house_no" placeholder="Enter the House No./Street Name/Landmark." value="<?php echo $enquiry_details[0]['enquiry_house_no'] ?>">
                                    <?php }else{ ?>
                                         <input type="text" class="form-control student_present_pre_house" name="student_present_house_no" placeholder="Enter the House No./Street Name/Landmark.">
                                    <?php } ?>
                                    </div>
                                    <label class="col-lg-2 control-label">Town<span style="color:red;">*</span></label>
                                    <div class="col-lg-3">
                                    <?php if($enquiry != 1){ ?>
                                        <input type="text" class="form-control student_present_pre_town" name="student_present_town" placeholder="Enter the Home Town" value="<?php echo $enquiry_details[0]['enquiry_town'] ?>">
                                    <?php }else{ ?>
                                        <input type="text" class="form-control student_present_pre_town" name="student_present_town" placeholder="Enter the Home Town">
                                    <?php } ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                    <?php if($enquiry != 1){ ?>
                                         <input type="text" class="form-control student_present_pre_tal" name="student_present_tal" placeholder="Enter the taluka." value="<?php echo $enquiry_details[0]['enquiry_tal'] ?>">
                                    <?php }else{ ?>
                                         <input type="text" class="form-control student_present_pre_tal" name="student_present_tal" placeholder="Enter the taluka.">
                                    <?php } ?>
                                    </div>
                                    <label class="col-lg-2 control-label">District<span style="color:red;">*</span></label>
                                    <div class="col-lg-3">
                                    <?php if($enquiry != 1){ ?>
                                        <input type="text" class="form-control student_present_pre_dist" name="student_present_dist" placeholder="Enter the District." value="<?php echo $enquiry_details[0]['enquiry_dist'] ?>">
                                    <?php }else{ ?>    
                                        <input type="text" class="form-control student_present_pre_dist" name="student_present_dist" placeholder="Enter the District.">
                                    <?php } ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">House No./Street Name/Landmark</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control student_permament_pre_house" name="student_permament_house_no" placeholder="Enter the House No./Street Name/Landmark.">
                                    </div>
                                    <label class="col-lg-2 control-label">Town</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control student_permament_pre_town" name="student_permament_town" placeholder="Enter the Home Town.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Taluka</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control student_permament_pre_tal" name="student_permament_tal" placeholder="Enter the taluka.">
                                    </div>
                                    <label class="col-lg-2 control-label">District</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control student_permament_pre_dist" name="student_permament_dist" placeholder="Enter the District.">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <?php if ($enquiry != 1){?>
                                            <textarea type="text" placeholder=" Student Present Address above_present_address" name="student_present_address" class="form-control"><?php echo $enquiry_details[0]['enquiry_residential_address'] ?></textarea>
                                        <?php }else{ ?>
                                    ...
                                    <div class="col-lg-3">
                                        <?php if ($enquiry != 1){?>
                                            <textarea type="text" placeholder=" Student Permament Address" name="student_permament_address" class="form-control student_pre_address1" ><?php echo $enquiry_details[0]['enquiry_residential_address'] ?></textarea>
                                        <?php }else{ ?>
                                            <textarea type="text" placeholder=" Student Permament Address" name="student_permament_address" class="form-control student_pre_address1"></textarea>
                                        <?php } ?>
                                    </div>
                                </div> -->
                                <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <?php if ($enquiry != 1){?>
                                            <input type="text" class="form-control" name="parent_occupation[0]" placeholder="Parent Occupation" value="<?php echo $enquiry_details[0]['enquiry_parent_occupation'] ?>">
                                        <?php }else{ ?>
                                            <input type="text" class="form-control" name="parent_occupation[0]" placeholder="Parent Occupation">
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">House No./Street Name/Landmark</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control parent_permament_father_house" name="parent_permament_house_no[0]" placeholder="Enter the House No./Street Name/Landmark.">
                                    </div>
                                    <label class="col-lg-2 control-label">Town</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control parent_permament_father_town" name="parent_permament_town[0]" placeholder="Enter the Home Town.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Taluka</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control parent_permament_father_tal" name="parent_permament_tal[0]" placeholder="Enter the taluka.">
                                    </div>
                                    <label class="col-lg-2 control-label">District</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control parent_permament_father_dist" name="parent_permament_dist[0]" placeholder="Enter the District.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="parent_occupation[1]" placeholder="Parent Occupation">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">House No./Street Name/Landmark</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control parent_permament_mother_house" name="parent_permament_house_no[1]" placeholder="Enter the House No./Street Name/Landmark.">
                                    </div>
                                    <label class="col-lg-2 control-label">Town</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control parent_permament_mother_town" name="parent_permament_town[1]" placeholder="Enter the Home Town.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Taluka</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control parent_permament_mother_tal" name="parent_permament_tal[1]" placeholder="Enter the taluka.">
                                    </div>
                                    <label class="col-lg-2 control-label">District</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control parent_permament_mother_dist" name="parent_permament_dist[1]" placeholder="Enter the District.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">Mother Address <span style="color:red;">*</span></label>
                                                        <div class="col-sm-6">
                                                            <textarea type="text" placeholder=" Parent Address" name="parent_address[1]" class="form-control mother_address_student"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <label class="radio-inline" style="padding-top:0px;"> 
                                                                <input type="checkbox" name="copy_address[0]" class="copy_address1">&nbsp Same As Student Address 
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <!-- <div class="form-group">
                                    <label class="col-lg-2 control-label">Mother Address</label>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="parent_occupation[2]" placeholder="Parent Occupation">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">House No./Street Name/Landmark</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control parent_permament_gardien_house" name="parent_permament_house_no[2]" placeholder="Enter the House No./Street Name/Landmark.">
                                    </div>
                                    <label class="col-lg-2 control-label">Town</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control parent_permament_gardien_town" name="parent_permament_town[2]" placeholder="Enter the Home Town.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Taluka</label>
                                    <div class="col-lg-3">
                                         <input type="text" class="form-control parent_permament_gardien_tal" name="parent_permament_tal[2]" placeholder="Enter the taluka.">
                                    </div>
                                    <label class="col-lg-2 control-label">District</label>
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control parent_permament_gardien_dist" name="parent_permament_dist[2]" placeholder="Enter the District.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">Gardian Address <span style="color:red;">*</span></label>
                                                        <div class="col-sm-6">
                                                            <textarea type="text" placeholder=" Parent Address" name="parent_address[2]" class="form-control gardien_student_address"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <label class="radio-inline" style="padding-top:0px;"> 
                                                                <input type="checkbox" name="copy_address[0]" class="copy_address2">&nbsp Same As Student Address 
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                               ...
                               <div class="ibox-title">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <button class="btn btn-primary enableOnInput" type="submit" id="submit">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
