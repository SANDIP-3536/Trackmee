                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" enctype="multipart/form-data" id="addStudent" action="<?=site_url('Student/add_student_registration')?>">
                                <div class="" id="student_details">
                                    <div class="ibox-title" style="border:none;padding-top:0%;border-bottom:1px solid #e7eaec;">
                                        <div class="row">
                                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 col-sm-offset-10">
                                            <span class="btn btn-success validation_first_next">Next   &nbsp<i class="fa fa-step-forward"></i></span></a>
                                            <span class="btn btn-success hidden">Next   &nbsp<i class="fa fa-step-forward"></i></span></a>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <div class="hidden" id="family_details">
                                    <div class="ibox-title" style="border:none;padding-top:0%;">
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <h3><b>Parent Details</b></h3>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                    ...
                                    <div id="father_details">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" name="parent_qualification[0]" placeholder="Parent Qualification" id="qwualifi" onkeyup="capitalize(this.id, this.value);">
                                            </div>
                                    ...
                                    <div id="mother_details">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" name="parent_qualification[1]" placeholder="Parent Qualification" id="mother_qual" onkeyup="capitalize(this.id, this.value);">
                                            </div>
                                    ...
                                    <div id="gardien_details">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" name="parent_qualification[2]" placeholder="Parent Qualification" id="gardien_qalif" onkeyup="capitalize(this.id, this.value);">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 col-sm-offset-10">
                                            <span class="btn btn-success first_back"><i class="fa fa-step-backward"></i>   &nbsp Previous</span></a>
                                            <span class="btn btn-success second_next">Next   &nbsp<i class="fa fa-step-forward"></i></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="hidden" id="document_details">
                                    <div class="ibox-title" style="border:none;padding-top:0%;">
                                        <div class="row">
                                            <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 col-sm-offset-10">
                                            <span class="btn btn-success second_back"><i class="fa fa-step-backward"></i>   &nbsp Previous</span></a>
                                            <span class="btn btn-success third_next">Next   &nbsp<i class="fa fa-step-forward"></i></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="hidden" id="class_fee_details">
                                    <div class="ibox-title" style="border:none;padding-top:0%;">
                                        <div class="row">
                                            <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 col-sm-offset-9">
                                            ...
                                            <span class="btn btn-success third_back"><i class="fa fa-step-backward"></i>   &nbsp Previous</span></a>
