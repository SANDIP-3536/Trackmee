                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content document_toggle">
                            <form method="post" class="form-horizontal" enctype="multipart/form-data" id="addStudent" action="<?=site_url('Driver/add_driver_document')?>">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-4">
                                        <a href="<?=site_url('Driver/view_driver')?>"><span class="btn btn-white">Cancel</span>
