                  ...
                  <div class="col-md-offset-1 col-md-3">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title" style="background: #2f4050;">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h5  style="color: #fff;">Driver Profile Photo </h5>
                                </div>
                            </div> 
                        </div>
                     ...
                     <div class="row">
                        <div class="col-lg-9">
                         ...
                         <div class="col-lg-3" style="text-align:right;">
                            <a class="btn btn-xs btn-white" href="<?=site_url('Driver/update_driver/'.$key['employee_profile_id'])?>"><i class="fa fa-pencil"></i> Edit </a>
                            <a class="btn btn-xs btn-white" href="<?=site_url('Driver/add_document/'.$key['employee_profile_id'])?>"><i class="fa fa-file"></i> Documents </a>
                         </div>            
                    </div>
                </div>
                        ...
                        <div class="feed-element" style="padding-top: 15px;">
                            <div class="media-body ">
                                <div class="form-group">
                                    <div class="col-sm-3"> <strong>Driver Name</strong></div>
