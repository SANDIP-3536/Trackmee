                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" enctype="multipart/form-data" id="addDriver" action="<?=site_url('Driver/update_driver_details')?>">
                                <div class="form-group" hidden="">
                                <?php foreach ($update_driver as $key) { ?>
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Driver Address</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                       <a href="<?=site_url('Driver/view_driver_details/' .$key['employee_profile_id'])?>"><span class="btn btn-white">Cancel</span>
                                         <?php } ?>
