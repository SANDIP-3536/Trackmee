        <div class="wrapper wrapper-content animated fadeInRight">
        	<div class="row">
        		<div class="col-lg-12">
        			<div class="ibox float-e-margins">
        				...
        				<div class="ibox-content notification_hide">
        					<form method="post" class="form-horizontal" enctype="multipart/form-data" id="addNotification" action="<?=site_url('Notification/add_other_notification')?>">
        		...
        		<div class="ibox-title">
        			<div class="row">
        				<div class="col-sm-6">
        					<h3><b>Other Notification History </b></h3>
        				</div>
        			</div>
        		</div>
