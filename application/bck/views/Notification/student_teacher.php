        		...
        		<div class="col-lg-12">
        			<div class="ibox float-e-margins">
        				<div class="ibox-title">
        					<div class="row">
        						<div class="col-sm-6">
        							<h3><b>Student Notification</b></h3>
        						</div>
        						<div class="col-sm-6">
        				...
        				<div class="ibox-content notification_hide">
        					<form method="post" class="form-horizontal" enctype="multipart/form-data" id="addNotification" action="<?=site_url('Notification/add_student_teacher')?>">
        ...
        <div class="ibox-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3><b>Student Notification History </b></h3>
                </div>
            </div>
        </div>
        <div class="ibox-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <tbody>
                        <?php $i=1;
                        foreach ($student_techer as $key1) {?>
                        <tr>
                            <td><?=$i++;?></td>
