        ...
        $(document).ready(function(){
            ...
            $('.add_stop').click(function(){
                ...
                var newUser = '<tr id="org">'+
                                '<th id="route_index">'+
                                    '<input type="text" name="route_index[]" class="form-control route_index" value="" style="border:none;">'+
                                '</th>'+
                                '<th id="route_name">'+
                                    '<input type="text" name="route_name[]" class="form-control route_name" style="border:none;">'+
                                '</th>'+
                                '<th id="latitude">'+
                                    '<input type="text" name="route_latitude[]" class="form-control latitude" style="border:none;">'+
                                '</th>'+
                                '<th id="longitude">'+
                                    '<input type="text" name="route_longitude[]" class="form-control longitude" style="border:none;">'+
                                '</th>'+
