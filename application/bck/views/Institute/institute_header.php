        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav">
                    ...
                    <li id="tracking"><a href="<?=site_url('Tracking/view_map_table_institute')?>"><img src="<?=base_url()?>assets/img/icon/tracking.png" style="display: -webkit-box;font-size: initial;padding-left: 12px;"></i> <b>Tracking </b></a></li>
                </ul>
