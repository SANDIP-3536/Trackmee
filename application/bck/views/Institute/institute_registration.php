                            ...
                            <form method="post" class="form-horizontal" id="addInstitute" action="<?=site_url('Institute/new_institute_registration')?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3" style="padding:10px;">
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" class="onoffswitch-checkbox" name="institute_tracking" id="example1">
                                    ...
                                    <div class="col-sm-3" style="padding:10px;">
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" class="onoffswitch-checkbox" name="institute_CRM" id="example2">
