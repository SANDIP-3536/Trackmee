                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data" id="addInstitute" action="<?=site_url('Institute/update_details_institute')?>">
                                ...
                                <div class="form-group update_functionality">
                                    ...
                                    <div class="col-sm-3" style="padding:10px;">
                                        ...
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" checked class="onoffswitch-checkbox" name="institute_tracking" id="example1">
                                        ...
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" class="onoffswitch-checkbox" name="institute_tracking" id="example2">
                                    ...
                                    <div class="col-sm-3" style="padding:10px;">
                                        ...
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" checked class="onoffswitch-checkbox" name="institute_CRM" id="example123">
                                                <label class="onoffswitch-label" for="example123">
                                                    <span class="onoffswitch-inner"></span>
                                                    <span class="onoffswitch-switch"></span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" class="onoffswitch-checkbox" name="institute_CRM" id="example22">
