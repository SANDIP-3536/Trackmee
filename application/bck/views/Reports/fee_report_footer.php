<div class="footer">
    ...
    <script>
        ...
        <?php if($report == 'fee'){?>
             $('#fee').addClass('active');
             document.title = "TrackMee | Accounting Reports"
        <?php } ?>
            ...
            if(school_batch == 1){
            	$.post('<?=site_url('Reports/school_total_fee_report')?>',function(data){
                    ...
                    total_fee_report.draw();
                        ...
                        $('#title').empty();
                        $('#title').append('School Wise Fee Report');
                        $('#example_data_head').empty();
                        $('#example_data').empty();
                        $('#example_data_head').append('<tr>'+
                                '<th>GRN No.</th>'+
                                '<th>Student Name</th><th>Father Name</th>'+                                                            
                                '<th>Gender</th><th>Mobile No.</th>'+                                                            
                                '<th>Class</th><th>Division</th>'+                                                            
                                '<th>Total Fee Amount</th><th>Total Fee Waiver Amount</th>'+                                                            
                                '<th>Paid Amount</th><th>Balance</th>'+                                                            
                            '</tr>');
                        ...
                        $('#example_data').append('<tr>'+
                            '<td>'+v.student_GRN+'</td>'+                                                  
                            '<td>'+v.student_name+'</td><td>'+v.parent_name+'</td>'+                                                  
                            '<td>'+v.student_gender+'</td><td>'+v.parent_mobile_number+'</td>'+                                                  
                            '<td>'+v.class_name+'</td><td>'+v.division_name+'</td>'+                                                  
                            '<td>'+v.total_fee_amount+'</td><td>'+v.fee_waiver_amount+'</td>'+                                                  
                            '<td>'+v.fee_amount+'</td><td>'+v.balance+'</td>'+                                                  
                            '</tr>');
                        });
                    $('#example_foot').attr('colspan',12);
                },'json');
            	...
            	$.post('<?=site_url('Reports/class_total_fee_report')?>',{class_id:class_id},function(data){
                    ...
                    total_fee_report.draw();
                        $('#title').empty();
                        $('#title').append('School Class Wise Fee Report');
                        $('#example_data_head').empty();
                        $('#example_data').empty();
                        $('#example_data_head').append('<tr>'+
                                '<th>GRN No.</th>'+
            	...
            	$.post('<?=site_url('Reports/division_total_fee_report')?>',{class_id:class_id,division_id:division_id},function(data){
                    ...
                    total_fee_report.draw();
                        ...
                        $('#title').empty();
                        $('#title').append('School Division Wise Fee Report');
                        $('#example_data_head').empty();
                        $('#example_data').empty();
                        $('#example_data_head').append('<tr>'+
                            '<th>GRN No.</th>'+
		...
		$(document).on('click','.show_due_fee_report',function(){
            ...
            if(school_batch == 1){
            	$.post('<?=site_url('Reports/school_due_fee_report')?>',function(data){
                    ...
                    $('#title').empty();
                    $('#title').append('School Wise Due Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
            	...
            	$.post('<?=site_url('Reports/class_due_fee_report')?>',{class_id:class_id},function(data){
                    ...
                    $('#title').empty();
                    $('#title').append('School Class Wise Due Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
            	...
            	$.post('<?=site_url('Reports/division_due_fee_report')?>',{class_id:class_id,division_id:division_id},function(data){
                    ...
                    due_fee_report.draw();
                    $('#title').empty();
                    $('#title').append('School Division Wise Due Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
        ...
        $(document).on('click','.show_paid_fee_report',function(){
            ...
            if(school_batch == 1){
                $.post('<?=site_url('Reports/school_paid_fee_report')?>',function(data){
                    ...
                    $('#title').empty();
                    $('#title').append('School Wise Paid Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
                ...
                $.post('<?=site_url('Reports/class_paid_fee_report')?>',{class_id:class_id},function(data){
                    ...
                    paid_fee_report.draw();
                    $('#title').empty();
                    $('#title').append('School Class Wise Paid Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
                ...
                $.post('<?=site_url('Reports/division_paid_fee_report')?>',{class_id:class_id,division_id:division_id},function(data){
                    ...
                    $('#title').empty();
                    $('#title').append('School Division Wise Paid Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
        ...
        $(document).on('click','.show_category_fee_report',function(){
            ...
            if(school_batch == 1){
                $.post('<?=site_url('Reports/school_fee_category_report')?>',function(data){
                    ...
                    $('#title').empty();
                    $('#title').append('School Wise Category Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
                        ...
                        '<th>Gender</th><th>Mobile No.</th>'+                                                            
                        '<th>Class</th><th>Division</th>'+                                                            
                        '<th>Fee Type name</th><th>Fee Type Amount</th>'+                                                        
                    '</tr>');
                    ...
                    $('#example_data').append('<tr>'+
                        ...
                        '<td>'+v.student_gender+'</td><td>'+v.parent_mobile_number+'</td>'+                                                  
                        '<td>'+v.class_name+'</td><td>'+v.division_name+'</td>'+                                                  
                        '<td>'+v.fees_type_name+'</td><td>'+v.total_fee_amount+'</td>'+                                                 
                        '</tr>');
                    });
                    $('#example_foot').attr('colspan',12);
                ...
                $.post('<?=site_url('Reports/class_fee_category_report')?>',{class_id:class_id,fee_type:fee_type},function(data){
                    ...
                    $('#title').empty();
                    $('#title').append('School Class Wise Category Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
                ...
                $.post('<?=site_url('Reports/division_fee_category_report')?>',{class_id:class_id,division_id:division_id},function(data){
                    ...
                    fee_category_report.draw();
                    $('#title').empty();
                    $('#title').append('School Division Wise Category Fee Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
        ...
        $(document).on('click','.show_waiver_fee_report',function(){
            ...
            if(school_batch == 1){
                $.post('<?=site_url('Reports/school_fee_waiver_report')?>',function(data){
                    ...
                    $('#title').empty();
                    $('#title').append('School Wise Fee Waiver Report');
                    $('#example_data_head').empty();
                    $('#example_data').empty();
                    $('#example_data_head').append('<tr>'+
                        '<th>GRN No.</th>'+
                        ...
                        '<th>Class</th><th>Division</th>'+                                                            
                        '<th>Fee Type name</th><th>Fee Type Amount</th>'+                                                        
                        '<th>Fee Waiver</th><th>Fee Waiver Amoun</th>'+                                                        
                    '</tr>');
                    ...
                    $('#example_data').append('<tr>'+
                        ...
                        '<td>'+v.class_name+'</td><td>'+v.division_name+'</td>'+                                                  
                        '<td>'+v.fees_type_name+'</td><td>'+v.total_fee_amount+'</td>'+                                                 
                        '<td>'+v.fee_waiver_name+'</td><td>'+v.fee_waiver_amount+'</td>'+                                                 
                        '</tr>');
                    });
                    $('#example_foot').attr('colspan',12);
                },'json');
