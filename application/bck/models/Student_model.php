...
class Student_model extends CI_model
{
	...
	{
		return $this->db->query("SELECT * FROM `fees_type` where fees_type_class_id =".$fee_type['class_id']." and fees_type_expiry_date = '9999-12-31' and fees_type_school_profile_id =".$fee_type['employee_school_profile_id']."")->result_array();
	}
	...
	{
		return $this->db->query("SELECT * FROM fees_type where fees_type_school_profile_id =".$employee_school_profile_id." and fees_type_expiry_date='9999-12-31' and fees_type_class_id = 0")->result_array();
	}
}
 ?>