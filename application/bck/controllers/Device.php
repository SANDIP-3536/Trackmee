	...
	*/
	class Device extends CI_Controller
	{
		...
		function device_registration()
		{
			...
			$device['device'] = $this->Device_model->fetch_device($employee_school_profile_id);
		...
		function add_registration()
		{
			...
			elseif($mobile_no != 0){
				...
				// $device_registration['device_moving_frequency'] =  $this->input->post('device_moving_frequency');
				...
				$device_registration['device_school_profile_id'] = $this->input->post('device_school_profile_id');
		...
		function update_device_details()
		{
			...
			// $data['device_moving_frequency'] =  $this->input->post('device_moving_frequency');
			...
			$data['device_school_profile_id'] = $this->input->post('device_school_profile_id');
			// $data['device_update_date'] = date('Y-m-d');
