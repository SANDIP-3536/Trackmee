<?php 
	...
	*/
	class Admin_model extends CI_model	{
		...
		function employee_details($emp)
		{
			return $this->db->select('*')->from('employee')->where('employee_profile_id',$emp[0]['employee_profile_id'])->where('employee_type',$emp[0]['employee_type'])->get()->result_array();
		}
	}
?>